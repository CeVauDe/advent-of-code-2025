import pytest
from part1 import IdChecker, Range
...
class TestIdChecker:
    ...
    @pytest.mark.parametrize(
        "id_", [11, 22, 99, 1010, 1188511885, 222222, 38593859, 446446]
    )
    ...
    def test_get_invalid_ids_from_str(self, id_checker) -> None:
        assert id_checker.get_invalid_ids_from_str("11-22") == {11, 22}
